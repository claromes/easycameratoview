...
class HEADER_MT_Panel(Menu):
    ...
    def draw(self, context):
      ...
      if lock is not False:
        row.operator(UNLOCK_OT_Camera_View.bl_idname, text='Camera to View', icon='LOCKED')
      else:
        row.operator(LOCK_OT_Camera_View.bl_idname, text='Camera to View', icon='UNLOCKED')